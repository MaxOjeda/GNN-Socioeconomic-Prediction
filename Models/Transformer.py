...
class TransformerClassification(torch.nn.Module):
    def __init__(self, input_channels, hidden_channels, output_channels, edge_dim=6, heads=1, dropout=0.5):
...
class TransformerRegression(torch.nn.Module):
    def __init__(self, input_channels, hidden_channels, output_channels, edge_dim=2, heads=1, dropout=0.5, num_layers=2):
